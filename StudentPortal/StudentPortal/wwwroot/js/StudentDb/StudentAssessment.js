...
userProfile?.addEventListener('click', () => userPopup?.classList.toggle('show'));
document.addEventListener('click', (e) => {
    // If clicked outside the userProfile, hide the popup
...
document.addEventListener('click', (e) => {
    // Close radial if clicked outside both the circle and the actions
